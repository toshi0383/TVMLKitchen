            ...
            <relatedContent>
              <grid>
                <section>
                  ...
                  <lockup>
                    <img src="${this.BASEURL}music_5.lcr" width="308" height="308" />
                    <title class="whiteText">Title 5</title>
                  </lockup>
                  <lockup>
                    <img src="${this.BASEURL}music_6.lcr" width="308" height="308" />
            ...
            <relatedContent>
              <grid>
                <section>
                  ...
                  <lockup>
                    <img src="${this.BASEURL}music_7.lcr" width="308" height="308" />
